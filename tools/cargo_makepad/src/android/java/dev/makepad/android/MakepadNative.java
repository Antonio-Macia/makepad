...
public class MakepadNative {
    ...
    public static native void onAndroidParams(String cache_path, String data_path, float density, float fontScale, boolean isEmulator, String androidVersion, String buildNumber,
